...
jado.map      = function (d,f)   {var k, r=_ct(d); for (k in d) {r[k]=f(d[k]);} return r; };
...
jado.valueOf  = function (x)     {return _to(x) == "function" ? x():x;};
...
//internally used syntactic sugar (short hand) but also avaible for external use
var _f      = jado._f  = jado.filter;              
var _fx     = jado.fx  = jado.filterx;
var _r      = jado._r  = jado.reduce;
var _rx     = jado._rx = jado.reducex;
var _m      = jado._m  = jado.map;
var _mx     = jado._mx = jado.mapx;
var _dc     = jado._dc = jado.deepClone;
var _ct     = jado._ct = jado.cloneType;
var _to     = jado._to = jado.typeOf; 
var _v      = jado._v  = jado.valueOf;
